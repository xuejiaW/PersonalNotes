...
如一个像素在 `View-Space` 的位置为 $(10.1,10.1,10.1)$，它其中一个采样点的偏移量为 $(0.25,0.25,0.25)$，则该采样点在 `View-Space` 的位置为 $(10.35,10.35,10.35)$。如果该采样点转换到屏幕空间中的位置是 $(0.3, 0.3)$，且该位置在屏幕空间的深度缓冲中的值为 $9$
