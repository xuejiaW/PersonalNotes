...
因为深度缓冲是基于 `View-Space` 的，因此此处 [G-buffer](Learn%20OpenGL%20-%20Ch%2033%20Deferred%20Shading.md#The%20G-buffer) 存储
对于屏幕空间的每个像素而言，通过  会为其生成一系列的采样点，每个采样点表示表示该像素在世界
