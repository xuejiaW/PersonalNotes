...
![左旋及右旋操作](assets/Ch%2013%20Red-Black%20Trees/2019-11-06-16-54-51.png)
...
![三种情况的示意图](assets/Ch%2013%20Red-Black%20Trees/2019-11-07-00-05-44.png)
...
![情况1的修复](assets/Ch%2013%20Red-Black%20Trees/2019-11-07-10-52-42.png)
...
![情况2转换为情况3](assets/Ch%2013%20Red-Black%20Trees/2019-11-09-20-08-02.png)

对于情况3，我们对$z.p.p$，即上图中的$C$进行右旋。旋转后如下图所示。

![情况3对于z.p.p右旋](assets/Ch%2013%20Red-Black%20Trees/2019-11-09-20-30-37.png)
...
![情况3变化](assets/Ch%2013%20Red-Black%20Trees/2019-11-09-20-35-41.png)

情况3调整后性质4和5都满足了，而不像情况1调整后仍然可能存在违背性质4的可能。

另外对于情况2和3的处理，不能是情况3通过右旋$z.p$来转换为情况2再进行修复。因为如果在情况2下对$C$进行右旋，会出现如下情况。

![对情况2进行直接修复](assets/Ch%2013%20Red-Black%20Trees/2019-11-09-20-44-24.png)
...
2. 如果$x$和$x.p$都为红色，那么破坏性质4。
	...
	![删除z违背性质4的情况](assets/Ch%2013%20Red-Black%20Trees/2019-11-16-15-17-38.png)
	![删除z违背性质4的情况2](assets/Ch%2013%20Red-Black%20Trees/2019-11-16-17-09-19.png)
...
![情况1修复](assets/Ch%2013%20Red-Black%20Trees/2019-11-16-16-28-06.png)
...
![情况2的修复](assets/Ch%2013%20Red-Black%20Trees/2019-11-16-17-31-28.png)

对于情况3的修复：

情况3通过降$w$（黑色）与$w.left$（红色）的颜色对换，并对$w$执行右旋，再将原$w.left$设为新$w$转换为情况4。如下图所示。

![情况3的修复](assets/Ch%2013%20Red-Black%20Trees/2019-11-16-17-39-14.png)

对于情况4的修复：

在情况4中，先将$w$与$w.p$的颜色互换，然后对$w.p$进行左旋，$w$取代原先$w.p$的位置。如下图所示

![情况4修复1](assets/Ch%2013%20Red-Black%20Trees/2019-11-16-18-16-43.png)
...
![情况4修复2](assets/Ch%2013%20Red-Black%20Trees/2019-11-16-18-20-17.png)
