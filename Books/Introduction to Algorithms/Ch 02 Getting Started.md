...
2. 插入排序类似于打牌整理手牌的过程，下为图解
    ![插入排序排列](Ch%2002%20Getting%20Started/2019-10-15-09-32-30.png)
...
4. 归并排序算法的伪代码
    ...
    ![归并排序图解](Ch%2002%20Getting%20Started/2019-10-15-23-14-44.png)
...
5. 归并排序中，最重要的就是最终合并的部分。在之前合并函数前，我们假定两个需要被合并的数组已经排序完毕。合并部分的伪代码如下
    ...
    ![合并部分算法图解](Ch%2002%20Getting%20Started/2019-10-15-15-16-31.png)
...
![归并排序时间复杂度分析1](Ch%2002%20Getting%20Started/2019-10-16-00-45-05.png)


我们可以重复递归这样的操作，直到属性结构变成下图所示：

![归并排序时间复杂度分析2](Ch%2002%20Getting%20Started/2019-10-16-00-46-41.png)
