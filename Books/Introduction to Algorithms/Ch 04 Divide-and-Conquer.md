...
![最大子数组](Ch%2004%20Divide-and-Conquer/2019-10-20-10-30-15.png)
...
![递归树_1](Ch%2004%20Divide-and-Conquer/2019-10-21-00-14-20.png)

$T(\frac{n}{4})$又可以表达为$T(\frac{n}{4})=3T(\frac{n}{16})+c(\frac{n}{4})^2$，于是树可以进一步拆分为：

![递归树_2](Ch%2004%20Divide-and-Conquer/2019-10-21-00-16-06.png)

同理类推，最终树可以拆分为:

![递归树_3](Ch%2004%20Divide-and-Conquer/2019-10-21-00-17-03.png)
